...
class EquipmentExercisesPage extends StatefulWidget {
  final String equipment;
  const EquipmentExercisesPage({Key? key, required this.equipment})
    : super(key: key);

  @override
  _EquipmentExercisesPageState createState() => _EquipmentExercisesPageState();
}

class _EquipmentExercisesPageState extends State<EquipmentExercisesPage> {
  ...
  void initState() {
    super.initState();
    _futureExercises = _apiService.fetchExercisesByEquipment(widget.equipment);
  }
      ...
      body: FutureBuilder<List<Exercise>>(
        ...
        builder: (context, snapshot) {
          ...
          if (exercises.isEmpty) {
            return Center(
              child: Text('No exercises found for ${widget.equipment}'),
            );
          }
